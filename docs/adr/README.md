...
このディレクトリでは、この Docker workspace の重要な設計判断を Architecture Decision Record (ADR) として管理します。
...
- `00001-adopt-docker-volume-workspace.md`
- `00002-store-runtime-notes-as-adr.md`
